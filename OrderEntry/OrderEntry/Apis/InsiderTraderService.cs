...
{
    public class InsiderTraderService(IOptions<InsiderTraderSettings> options, IDatabaseService databaseService, IPolygonApiService polygonApiService) : IInsiderTraderService
    {
